    ...
    public function index() {
        ...
        $purifier_config->set('Cache.SerializerPath', UPLOADS_PATH . 'cache');
            ...
            $_POST['settings'] = [
                ...
                /* AI */
                'ai_static_prompts_per_month_limit' => (int) $_POST['ai_static_prompts_per_month_limit'],
                'ai_static_prompts_characters_limit' => (int) $_POST['ai_static_prompts_characters_limit'],
            ];
