...
return [
    ...
    'admin_plans.plan.flipbooks_limit_help' => 'The total amount of flipbooks that a user can create. Set -1 for unlimited.',
    ...
    'admin_users.source.lifetime_checkout' => 'Lifetime checkout',
    ...
    'admin_user_update.plan.subscription_period_start' => 'Subscription period start / payment date',
    'admin_user_update.plan.subscription_period_start_help' => 'Used when syncing the user into Subscriptions. If the user paid late, set the real payment date so the billing timeline and current period are accurate.',
    'admin_user_update.plan.subscription_period_start_invalid' => 'The subscription period start date is invalid.',
	...
	'admin_subscriptions.menu' => 'Subscriptions',
	'admin_subscriptions.title' => 'Subscriptions',
	'admin_subscriptions.header' => 'Subscriptions',
	'admin_subscriptions.no_data' => 'No subscriptions found',
	'admin_subscriptions.plan' => 'Plan',
	'admin_subscriptions.mrr' => 'Estimated MRR',
	'admin_subscriptions.arr' => 'Estimated ARR',
	'admin_subscriptions.mrr_contribution' => 'MRR contribution',
	'admin_subscriptions.currency_conversion_missing' => 'Conversion missing',
	'admin_subscriptions.view.header' => 'Subscription %s',
	'admin_subscriptions.view.subheader' => 'Subscription lifecycle, invoices, entitlements, and billing events.',
	'admin_subscriptions.subscription_details' => 'Subscription details',
	'admin_subscriptions.subscription_details_help' => 'Operational state for this managed subscription.',
	'admin_subscriptions.external_id' => 'External ID',
	'admin_subscriptions.manual_period' => 'Manual billing period',
	'admin_subscriptions.manual_period_help' => 'Record a manual monthly or annual renewal using the configured plan price.',
	'admin_subscriptions.currency' => 'Currency',
	'admin_subscriptions.payment_datetime' => 'Payment date',
	'admin_subscriptions.payment_datetime_help' => 'Use the real date the customer paid. If the previous period is expired, the new period starts from this date.',
	'admin_subscriptions.invoice_paid_on' => 'Paid on',
	'admin_subscriptions.edit_invoice_paid_datetime' => 'Edit paid date',
	'admin_subscriptions.edit_invoice_paid_datetime_help' => 'Change the paid date for this existing invoice and its linked payment record. This does not create a new renewal.',
	'admin_subscriptions.price_not_configured' => 'Price not configured',
	'admin_subscriptions.manual_period_submit' => 'Apply manual renewal',
	'admin_subscriptions.entitlements_help' => 'Resolved feature access from plan settings, plan entitlements, and subscription overrides.',
	'admin_subscriptions.items' => 'Subscription items',
	'admin_subscriptions.dunning_attempts' => 'Dunning attempts',
	'admin_subscriptions.scheduled' => 'Scheduled',
	'admin_subscriptions.action.sync_user' => 'Sync user plan',
	'admin_subscriptions.action.sync_from_user' => 'Sync subscription from user',
	'admin_subscriptions.action.mark_past_due' => 'Mark past due',
	'admin_subscriptions.confirm.manual_period' => 'Apply this manual billing period and extend the user access?',
	'admin_subscriptions.confirm.pause' => 'Pause this subscription locally?',
	'admin_subscriptions.confirm.cancel' => 'Cancel this subscription? Gateway-backed subscriptions will be canceled through the processor first.',
	'admin_subscriptions.error_message.manual_period_failed' => 'The manual renewal could not be applied. Check that this is not a lifetime subscription and that the selected plan price exists.',
	'admin_subscriptions.error_message.invoice_paid_datetime_failed' => 'The invoice paid date could not be updated.',
	'admin_subscriptions.success_message.manual_period_applied' => 'Manual renewal of %1$s for %2$s was applied. Access now runs until %3$s.',
	'admin_subscriptions.success_message.invoice_paid_datetime_updated' => 'The invoice paid date was updated successfully.',
	'admin_subscriptions.success_message.subscription_canceled' => 'The subscription was canceled successfully.',
	'admin_subscriptions.success_message.subscription_paused' => 'The subscription was paused successfully.',
	'admin_subscriptions.success_message.subscription_resumed' => 'The subscription was resumed successfully.',
	'admin_subscriptions.success_message.subscription_past_due' => 'The subscription was marked as past due.',
	'admin_subscriptions.success_message.user_synced' => 'The user plan was synced from the subscription.',
	'admin_subscriptions.success_message.subscription_synced_from_user' => 'The subscription was synced from the current user plan.',
];
