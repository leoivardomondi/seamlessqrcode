    ...
    $('form[name="create_link"],form[name="create_biolink"],form[name="create_file"],form[name="create_vcard"],form[name="create_event"],form[name="create_static"]').on('submit', event => {
        ...
        $.ajax({
            ...
            error: (xhr, text_status, error_thrown) => {
                ...
                console.error('Link creation request failed', {
                    status: xhr.status,
                    text_status,
                    error_thrown,
                ...
                let message = <?= json_encode(l('global.error_message.basic')) ?>;

                if(xhr.responseJSON && xhr.responseJSON.message) {
                    message = xhr.responseJSON.message;
                }

                display_notifications(message, 'error', notification_container);
            },
        });
