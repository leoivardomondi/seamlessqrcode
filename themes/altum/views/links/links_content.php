                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column min-width-0">
                                    <div class="d-inline-block text-truncate">
                                        ...
                                        <?php if($row->qr_codes_count): ?>
                                            <span data-toggle="tooltip" title="<?= sprintf(l('links.qr_code_connected'), nr($row->qr_codes_count)) ?>">
                                                <i class="fas fa-fw fa-xs fa-qrcode text-primary"></i>
                                            </span>
                                        <?php endif ?>
