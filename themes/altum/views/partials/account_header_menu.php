...
<div class="d-lg-none mb-4">
    ...
    <?php if(settings()->payment->is_enabled): ?>
        <option value="<?= url('account-billing') ?>" <?= \Altum\Router::$controller_key == 'account-billing' ? 'selected="selected"' : null ?>><?= l('account_billing.menu') ?></option>
...
<div class="row d-none d-lg-flex mb-4">
    ...
    <?php if(settings()->payment->is_enabled): ?>
        <div class="col-lg-4 p-2 text-truncate">
            <a class="btn btn-block btn-custom text-truncate  <?= \Altum\Router::$controller_key == 'account-billing' ? 'active' : null ?>" href="<?= url('account-billing') ?>">
                <i class="fas fa-fw fa-sm fa-repeat mr-2"></i> <?= l('account_billing.menu') ?>
            </a>
        </div>
