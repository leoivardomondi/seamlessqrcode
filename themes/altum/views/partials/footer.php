...
<div class="d-flex flex-column flex-lg-row justify-content-between mb-3">
    <div class="mb-3 mb-lg-0">
        ...
        <!-- SaaS Browser Badge Added -->
        <div class="mt-3">
            <a href="https://saasbrowser.com" target="_blank" rel="noopener noreferrer" title="Find, Compare, and Buy SaaS">
                <img src="https://static-files.saasbrowser.com/saas-browser-badge-12.svg" alt="SaaS Browser Badge" style="height: 40px;" />
            </a>
        </div>
        <!-- End of Badge -->
