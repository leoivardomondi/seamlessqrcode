            ...
            <div class="dropdown-menu dropdown-menu-right">
                <?php if(!\Altum\Teams::is_delegated()): ?>
                    ...
                    <?php if(settings()->payment->is_enabled): ?>
                        <a class="dropdown-item <?= in_array(\Altum\Router::$controller, ['AccountBilling']) ? 'active' : null ?>" href="<?= url('account-billing') ?>"><i class="fas fa-fw fa-sm fa-repeat mr-2"></i> <?= l('account_billing.menu') ?></a>
