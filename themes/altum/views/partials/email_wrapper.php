...
<?php $is_broadcast = $data->is_broadcast ?? false; ?>
...
<head>
    ...
    <style>
        ...
        body {
            background-color: <?= $is_broadcast ? '#f5f7fb' : '#fff' ?>;
        ...
        .container {
            ...
            /* makes it centered */
            max-width: <?= $is_broadcast ? '760px' : '620px' ?>;
            padding: <?= $is_broadcast ? '6px' : '10px' ?>;
            width: 100%;
        }
        ...
        .main {
            background: #fff;
            border: <?= $is_broadcast ? '0' : '1px solid transparent' ?>;
        ...
        .wrapper {
            box-sizing: border-box;
            padding: <?= $is_broadcast ? '24px' : '30px' ?>;
        }
        ...
        @media only screen and (max-width: 640px) {
            .wrapper {
                padding: <?= $is_broadcast ? '16px' : '20px' ?> !important;
            }
            .content {
                padding: <?= $is_broadcast ? '0' : '7.5px' ?> !important;
    ...
    <tr>
        ...
        <td class="container" width="100%" align="center">
            <div class="content">
                ...
                <table role="presentation" class="main" width="100%" style="max-width: <?= $is_broadcast ? '760px' : '620px' ?>;">
