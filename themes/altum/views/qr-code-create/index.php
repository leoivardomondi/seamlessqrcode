...
<div class="container">
    ...
    <form id="form" action="" method="post" role="form" enctype="multipart/form-data">
        ...
        <input type="hidden" name="dynamic_url_slug" value="<?= $data->values['dynamic_url_slug'] ?? null ?>" data-reload-qr-code />
                        ...
                        <div>
                            ...
                            <div class="form-group" data-type="url" data-link-id>
                                ...
                                <select id="link_id" name="link_id" class="custom-select" data-reload-qr-code>
                                    <option value="" data-url="<?= SITE_URL . ($data->values['dynamic_url_slug'] ?? null) ?>" data-location-url=""><?= l('global.none') ?> - <?= l('qr_codes.input.link_id_auto_create') ?></option>
                                    <?php foreach($data->links as $row): ?>
                                        <option value="<?= $row->link_id ?>" <?= ($data->values['link_id'] ?? null) == $row->link_id ? 'selected="selected"' : null?> data-url="<?= $row->full_url ?>" data-location-url="<?= $row->location_url ?>">
                        ...
                        <div class="collapse" id="options_container" data-parent="#form">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input id="size" type="number" min="50" max="2000" name="size" class="form-control <?= \Altum\Alerts::has_field_errors('size') ? 'is-invalid' : null ?>" value="<?= $data->values['settings']['size'] ?? 1864 ?>" data-reload-qr-code />
                            ...
                            <div class="form-group">
                                ...
                                <select id="ecc" name="ecc" class="custom-select" data-reload-qr-code>
                                    <?php foreach(['L', 'M', 'Q', 'H'] as $level): ?>
                                        <option value="<?= $level ?>" <?= ($data->values['settings']['ecc'] ?? 'H') == $level ? 'selected="selected"' : null ?>><?= l('qr_codes.input.ecc_' . mb_strtolower($level)) ?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>
