        ...
        <form action="" method="post" role="form">
            ...
            <div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="flipbooks_limit" name="flipbooks_limit" min="-1" class="form-control" value="0" />
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="ai_static_prompts_per_month_limit" name="ai_static_prompts_per_month_limit" min="-1" class="form-control" value="0" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>

                <div class="form-group">
                    <label for="ai_static_prompts_characters_limit"><?= l('admin_plans.plan.ai_static_prompts_characters_limit') ?></small></label>
                    <input type="number" id="ai_static_prompts_characters_limit" name="ai_static_prompts_characters_limit" min="-1" class="form-control" value="0" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>
