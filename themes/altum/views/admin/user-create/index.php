...
<div class="card <?= \Altum\Alerts::has_field_errors() ? 'border-danger' : null ?>">
    <div class="card-body">
        ...
        <form action="" method="post" role="form">
            ...
            <div class="form-group">
                <label for="type"><i class="fas fa-fw fa-sm fa-user-shield text-muted mr-1"></i> Role</label>
                <select id="type" name="type" class="custom-select">
                    <option value="0" <?= $data->values['type'] == 0 ? 'selected="selected"' : null ?>>User</option>
                    <option value="1" <?= $data->values['type'] == 1 ? 'selected="selected"' : null ?>>Admin</option>
                    <option value="2" <?= $data->values['type'] == 2 ? 'selected="selected"' : null ?>>Superadmin</option>
                </select>
