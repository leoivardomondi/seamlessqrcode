                    ...
                    <form action="" method="get" role="form">
                        ...
                        <div class="form-group px-4">
                            ...
                            <select name="type" id="filters_type" class="custom-select custom-select-sm">
                                ...
                                <option value="1" <?= isset($data->filters->filters['type']) && $data->filters->filters['type'] == '1' ? 'selected="selected"' : null ?>>Admin</option>
                                <option value="2" <?= isset($data->filters->filters['type']) && $data->filters->filters['type'] == '2' ? 'selected="selected"' : null ?>>Superadmin</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group px-4">
                            ...
                            <select name="source" id="filters_source" class="custom-select custom-select-sm">
                                <option value=""><?= l('global.all') ?></option>
                                <?php foreach(['direct', 'admin_create', 'admin_api_create', 'lifetime_checkout', 'facebook', 'twitter', 'discord', 'google', 'linkedin', 'microsoft'] as $source): ?>
                ...
                <tr>
                    ...
                    <td class="text-nowrap">
                        <div class="d-flex">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <span class="small text-muted"><?= \Altum\Authentication::get_role_label($row) ?></span>
                            </div>
                        </div>
                    </td>
                    <td class="text-nowrap">
                    ...
                    <td>
                        <div class="d-flex justify-content-end">
                            <?= include_view(THEME_PATH . 'views/admin/users/admin_user_dropdown_button.php', ['id' => $row->user_id, 'resource_name' => $row->name, 'type' => $row->type]) ?>
                        </div>
                    </td>
                </tr>
            <?php endforeach ?>
