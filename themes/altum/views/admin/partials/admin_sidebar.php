...
<section class="admin-sidebar">
    ...
    <div class="admin-sidebar-links-wrapper">
        <ul class="admin-sidebar-links">
            ...
            <li class="<?= \Altum\Router::$controller == 'AdminSetupProjects' ? 'active' : null ?>">
                <a class="nav-link text-truncate" href="<?= url('admin/setup-projects') ?>">
                    <i class="fas fa-fw fa-sm fa-clipboard-list mr-2"></i> Setup projects
                </a>
            </li>
            ...
            <?php if($is_superadmin && in_array(settings()->license->type, ['SPECIAL','Extended License', 'extended'])): ?>
                ...
                <li class="<?= \Altum\Router::$controller == 'AdminSubscriptions' ? 'active' : null ?>">
                    <a class="nav-link text-truncate" href="<?= url('admin/subscriptions') ?>">
                        <i class="fas fa-fw fa-sm fa-repeat mr-2"></i> <?= l('admin_subscriptions.menu') ?>
                    </a>
                </li>
            ...
            <li class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <?php if(settings()->payment->is_enabled): ?>
                        <a class="dropdown-item" href="<?= url('account-billing') ?>"><i class="fas fa-fw fa-sm fa-repeat mr-2"></i> <?= l('account_billing.menu') ?></a>
