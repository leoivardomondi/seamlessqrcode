...
<footer class="d-flex flex-column flex-lg-row justify-content-between">
    <div class="mb-3 mb-lg-0">
        ...
        <div>
            Powered by
            <?php if(settings()->main->favicon): ?>
                <img src="<?= settings()->main->favicon_full_url ?>" class="icon-favicon" alt="<?= settings()->main->title ?> logo" />
            <?php endif ?>
            <a href="<?= SITE_URL ?>"><?= settings()->main->title ?></a>.
        </div>
    </div>
    ...
    <div class="d-flex flex-column flex-lg-row">
        ...
        <?php if(is_logged_in() && (user()->type > 0 && settings()->main->admin_spotlight_is_enabled) || (settings()->main->user_spotlight_is_enabled && user()->type == 0)): ?>
            <div class="ml-lg-3">
