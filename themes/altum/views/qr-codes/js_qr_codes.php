...
<script>
    ...
    let url_dynamic_handler = () => {
        ...
        if(url_dynamic) {
            ...
            document.querySelector('#link_id') && document.querySelector('#link_id').removeAttribute('required');
    ...
    let link_id_handler = () => {
        ...
        if(link_id_element && link_id_element.options && document.querySelector('#url_dynamic') && document.querySelector('#url_dynamic').checked) {
            let location_url = link_id_element.options[link_id_element.selectedIndex].getAttribute('data-location-url');
            if(location_url) {
                document.querySelector('#url').value = location_url;
            }
        }
    }
                ...
                .then(data => {
                    if(data.status == 'error') {
                        ...
                        if(document.querySelector('#embedded_data_container_button')) {
                            ...
                            document.querySelector('#embedded_data_copy') && document.querySelector('#embedded_data_copy').setAttribute('data-clipboard-text', data.details.embedded_data);
