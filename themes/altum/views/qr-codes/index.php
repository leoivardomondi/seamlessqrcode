                        ...
                        <tr>
                                        ...
                                        <?php if($row->type == 'url'): ?>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <?php if($row->link_id): ?>
                                                    ...
                                                    <a href="<?= url('qr-code-statistics/' . $row->qr_code_id) ?>" class="btn btn-sm btn-link" data-toggle="tooltip" title="<?= l('link.statistics.pageviews') ?>"><i class="fas fa-fw fa-chart-bar"></i></a>
                                                <?php endif ?>
                                            </div>
                                        <?php endif ?>
                                    </div>
                            ...
                            <td>
                                <div class="d-flex justify-content-end">
                                    ...
                                    <?= include_view(THEME_PATH . 'views/qr-codes/qr_code_dropdown_button.php', ['id' => $row->qr_code_id, 'link_id' => $row->link_id, 'resource_name' => $row->name]) ?>
                                </div>
                            </td>
                        </tr>
                    <?php endforeach ?>
